...
my $data = [3.0, 2.8, 4.0, 5.5, 7.5, 6.8, 5.4, 6.0, 5.0, 6.2, 7.5, 6.5, 7.5, 8.1,
...
my $c = new XYChart(300, 180, 0xffffa0, 0x000000);
...
my $snowPattern = $c->patternColor2(dirname($0)."/snow.png");
