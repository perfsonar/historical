...
URL:			http://search.cpan.org/dist/perl-perfSONAR_PS-TL1Collector/
...
TL1 counters from network devices. This service comes packaged with a collector
that is capable of gathering this information. The data is stored in SQL
capable databases.  
