...
my $b = $c->addLegend(465, 70, 1, "arialbi.ttf", 11);
$b->setBackground($c->patternColor("marble2.png"), $perlchartdir::Transparent, 1);
...
$c->sector(4)->setLabelStyle("arial.ttf", 8, 0x000080)->setBackground(
    $perlchartdir::SameAsMainColor, 0x000000, 2);
