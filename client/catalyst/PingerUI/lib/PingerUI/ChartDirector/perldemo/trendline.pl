...
my $labels = ["Jan 2000", "Feb 2000", "Mar 2000", "Apr 2000", "May 2000", "Jun 2000",
...
my $c = new XYChart(500, 320, 0xffccff, 0x000000, 1);
...
$c->addLegend(55, 22, 0, "", 8)->setBackground($perlchartdir::Transparent);
