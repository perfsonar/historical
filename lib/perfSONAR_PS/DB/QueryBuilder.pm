package  perfSONAR_PS::DB::QueryBuilder;
...
perfSONAR_PS::DB::QueryBuilder - Build SQL queries based on DB engine type and supplied perl data structure, this was taken away from Rose::DB framework
...
C<perfSONAR_PS::DB::QueryBuilder> is used to build SQL queries.  It (optionally) exports two functions: C<build_select()> and C<build_where_clause()>.
