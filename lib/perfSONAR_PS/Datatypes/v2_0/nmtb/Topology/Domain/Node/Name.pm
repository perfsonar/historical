package  perfSONAR_PS::Datatypes::v2_0::nmtb::Topology::Domain::Node::Name;
use strict;
use warnings;
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::Datatypes::v2_0::nmtb::Topology::Domain::Node::Name->new($DOM_Obj);
...
use fields qw(nsmap idmap refidmap type    text );

perfSONAR_PS::Datatypes::v2_0::nmtb::Topology::Domain::Node::Name->mk_accessors(perfSONAR_PS::Datatypes::v2_0::nmtb::Topology::Domain::Node::Name->show_fields('Public'));
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::Datatypes::v2_0::nmtb::Topology::Domain::Node::Name';
...
sub getDOM {
    ...
    my $name = getElement({name =>   $LOCALNAME, parent => $parent , ns => \@nss,
                             attributes => [
...
sub merge {
    ...
    my $new_name = shift;
    my $logger  = get_logger( $CLASSPATH );  
    unless($new_name && blessed $new_name && $new_name->can("getDOM")) {
