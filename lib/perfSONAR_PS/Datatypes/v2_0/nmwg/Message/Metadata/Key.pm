package  perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Metadata::Key;
use strict;
use warnings;
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Metadata::Key->new($DOM_Obj);
...
perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Metadata::Key->mk_accessors(perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Metadata::Key->show_fields('Public'));
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Metadata::Key';
...
sub getDOM {
    ...
    my $key = getElement({name =>   $LOCALNAME, parent => $parent , ns => \@nss,
                             attributes => [
...
sub fromDOM {
    ...
    foreach my $childnode ($dom->childNodes) { 
        ...
        if ($tagname eq  'parameters' && $nsid eq 'nmwg' && $self->can($tagname)) { 
           my $element = undef;
           eval {
               $element = perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Metadata::Key::Parameters->new($childnode) 
           };
