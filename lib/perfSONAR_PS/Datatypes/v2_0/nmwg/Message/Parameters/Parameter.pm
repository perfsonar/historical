...
sub  querySQL {
    ...
    $query->{time}{resolution}= [ 'perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Parameters::Parameter' ] if!(defined $query->{time}{resolution}) || ref($query->{time}{resolution});
    $query->{time}{cf}= [ 'perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Parameters::Parameter' ] if!(defined $query->{time}{cf}) || ref($query->{time}{cf});
