package  perfSONAR_PS::Datatypes::v2_0::select::Message::Metadata::Parameters;
use strict;
use warnings;
...
=head1 NAME
 ...
 perfSONAR_PS::Datatypes::v2_0::select::Message::Metadata::Parameters  - A base class, implements  'parameters'  element from the perfSONAR_PS RelaxNG schema
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::Datatypes::v2_0::select::Message::Metadata::Parameters->new($DOM_Obj);
...
perfSONAR_PS::Datatypes::v2_0::select::Message::Metadata::Parameters->mk_accessors(perfSONAR_PS::Datatypes::v2_0::select::Message::Metadata::Parameters->show_fields('Public'));
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::Datatypes::v2_0::select::Message::Metadata::Parameters';
