package  perfSONAR_PS::Datatypes::v2_0::pinger::Message::Metadata::Subject::Parameters;
use strict;
use warnings;
...
=head1 NAME
 ...
 perfSONAR_PS::Datatypes::v2_0::pinger::Message::Metadata::Subject::Parameters  - A base class, implements  'parameters'  element from the perfSONAR_PS RelaxNG schema
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::Datatypes::v2_0::pinger::Message::Metadata::Subject::Parameters->new($DOM_Obj);
...
perfSONAR_PS::Datatypes::v2_0::pinger::Message::Metadata::Subject::Parameters->mk_accessors(perfSONAR_PS::Datatypes::v2_0::pinger::Message::Metadata::Subject::Parameters->show_fields('Public'));
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::Datatypes::v2_0::pinger::Message::Metadata::Subject::Parameters';
...
sub fromDOM {
    ...
    foreach my $childnode ($dom->childNodes) { 
        ...
        if ($tagname eq  'parameter' && $nsid eq 'nmwg' && $self->can($tagname)) { 
           my $element = undef;
           eval {
               $element = perfSONAR_PS::Datatypes::v2_0::nmwg::Message::Metadata::Subject::Parameters::Parameter->new($childnode) 
           };
