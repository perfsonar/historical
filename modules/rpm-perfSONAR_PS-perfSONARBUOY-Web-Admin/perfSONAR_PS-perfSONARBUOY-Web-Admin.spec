Name:           perfSONAR_PS-perfSONARBUOY-Web-Admin
Version:        0.09
Release:        1%{?dist}
Summary:        perfSONAR_PS Web utility for configuring perfSONAR-PS services
License:        distributable, see LICENSE
Group:          Development/Libraries
Source0:        perfSONAR_PS-perfSONARBUOY-Web-Admin.tar.gz
BuildRoot:      %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
Requires:       perfSONAR_PS-perfSONARBUOY
...
%define daemon_conf_file  %{daemon_conf_dir}/perfsonarbuoy.conf

%description
This package includes a CGI script for configuring a perfSONARBUOY Measurement
Archive.

%prep
%setup -q -n perfSONAR_PS-perfSONARBUOY-Web-Admin
...
install -p -m755 web-admin.cgi %{buildroot}/var/www/cgi-bin/perfSONAR-PS/perfsonarbuoy-web-admin.cgi
mkdir -p %{buildroot}/etc/httpd/conf.d
install -p -m644 perfsonar-httpd.conf %{buildroot}/etc/httpd/conf.d/perfSONAR-PS-perfSONARBUOY-Web-Admin.conf
...
%files
%defattr(-,root,root,-)
%doc Changes LICENSE README perfSONAR_PS-perfSONARBUOY-Web-Admin.spec
/etc/httpd/conf.d/*
/var/www/cgi-bin/*
