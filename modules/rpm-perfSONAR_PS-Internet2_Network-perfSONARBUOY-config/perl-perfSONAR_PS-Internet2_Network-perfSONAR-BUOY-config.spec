...
Name:           perl-perfSONAR_PS-Internet2_Network-perfSONAR-BUOY-config
Version:        0.10
Release:        1%{?dist}
Summary:        perfSONAR_PS perfSONAR-BUOY Config Package for the Internet2 Network
License:        distributable, see LICENSE
Group:          Development/Libraries
URL:            http://search.cpan.org/dist/perfSONAR_PS-perfSONAR-BUOY/
Source0:        perfSONAR_PS-Internet2_Network-perfSONAR-BUOY-config.tar.gz
...
%prep
%setup -q -n perfSONAR_PS-Internet2_Network-perfSONAR-BUOY-config
