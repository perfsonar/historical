...
# -M perfSONAR_PS::Collectors::LinkStatus::Agent::TL1::Base \
# -M perfSONAR_PS::Collectors::LinkStatus::Agent::TL1::Ciena \
# -M perfSONAR_PS::Collectors::LinkStatus::Agent::TL1 \
# -M perfSONAR_PS::Collectors::LinkStatus::Agent::TL1::TL1 \
