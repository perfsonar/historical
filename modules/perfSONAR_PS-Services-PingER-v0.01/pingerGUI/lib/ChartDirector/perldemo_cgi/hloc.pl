...
#
my $highData = [2043, 2039, 2076, 2064, 2048, 2058, 2070, 2033, 2027, 2029, 2071,
    2085, 2034, 2031, 2056, 2128, 2180, 2183, 2192, 2213, 2230, 2281, 2272];

my $lowData = [1931, 1921, 1985, 2028, 1986, 1994, 1999, 1958, 1943, 1944, 1962,
    2011, 1975, 1962, 1928, 2059, 2112, 2103, 2151, 2127, 2123, 2152, 2212];

my $openData = [2000, 1957, 1993, 2037, 2018, 2021, 2045, 2009, 1959, 1985, 2008,
    2048, 2006, 2010, 1971, 2080, 2116, 2137, 2170, 2172, 2171, 2191, 2240];

my $closeData = [1950, 1991, 2026, 2029, 2004, 2053, 2011, 1962, 1987, 2019, 2040,
    2016, 1996, 1985, 2006, 2113, 2142, 2167, 2158, 2201, 2188, 2231, 2242];

# The labels for the HLOC chart
my $labels = ["Mon 1", "Tue 2", "Wed 3", "Thu 4", "Fri 5", "Mon 8", "Tue 9",
...
# down days
my $layer = $c->addHLOCLayer3($highData, $lowData, $openData, $closeData, 0x008000,
    0xff0000);
