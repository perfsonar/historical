...
use fields qw( snmp pinger traceroute ping owamp bwctl iperf filetransfer );
perfSONAR_PS::Datatypes::EventTypes::Tools->mk_accessors(
    perfSONAR_PS::Datatypes::EventTypes::Tools->show_fields('Public') );
...
'pinger'  'traceroute','snmp', 'ping', 'owamp',   'bwctl', 'pinger', 'iperf', 'filetransfer'
...
$Id: Tools.pm 2640 2009-03-20 01:21:21Z zurawski $
