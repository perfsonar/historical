package  perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Subject;
...
perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Subject  -  this is data binding class for  'subject'  element from the XML schema namespace average
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Subject->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Subject->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Subject';
