package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message  -  this is data binding class for  'message'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message->new({xml => $xml_string});
...
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters;
...
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'parameters' && $nsid eq 'nmwg' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters->new($childnode)
                };
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
               ...
               ($self->get_metadata && ref($self->get_metadata) eq 'ARRAY')?push @{$self->get_metadata}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
