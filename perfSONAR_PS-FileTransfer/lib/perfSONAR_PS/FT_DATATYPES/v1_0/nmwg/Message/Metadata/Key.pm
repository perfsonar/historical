package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key  -  this is data binding class for  'key'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key';
