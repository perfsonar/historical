package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter  -  this is data binding class for  'parameter'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{time}{start}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{start}) || ref($query->{time}{start});
     $query->{time}{end}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{end}) || ref($query->{time}{end});
     $query->{limit}{setLimit}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{limit}{setLimit}) || ref($query->{limit}{setLimit});
     $query->{Metadata}{Program}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{Program}) || ref($query->{Metadata}{Program});
     $query->{Metadata}{Stripes}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{Stripes}) || ref($query->{Metadata}{Stripes});
     $query->{Metadata}{Streams}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{Streams}) || ref($query->{Metadata}{Streams});
     $query->{Metadata}{DestPath}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{DestPath}) || ref($query->{Metadata}{DestPath});
     $query->{Metadata}{User}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{User}) || ref($query->{Metadata}{User});
     $query->{Metadata}{SrcPath}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{SrcPath}) || ref($query->{Metadata}{SrcPath});
     $query->{Metadata}{BufferSize}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{BufferSize}) || ref($query->{Metadata}{BufferSize});
     $query->{Metadata}{BlockSize}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{BlockSize}) || ref($query->{Metadata}{BlockSize});
     $query->{time}{start}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{start}) || ref($query->{time}{start});
     $query->{time}{end}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{time}{end}) || ref($query->{time}{end});
     $query->{limit}{setLimit}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{limit}{setLimit}) || ref($query->{limit}{setLimit});
     $query->{Metadata}{Program}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter' ] if!(defined $query->{Metadata}{Program}) || ref($query->{Metadata}{Program});
            ...
            foreach my $entry (@{$defined_table{$table}}) {
                if(ref($query->{$table}{$entry}) eq 'ARRAY') {
                    foreach my $classes (@{$query->{$table}{$entry}}) {
                         if($classes && $classes eq 'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters::Parameter') {
