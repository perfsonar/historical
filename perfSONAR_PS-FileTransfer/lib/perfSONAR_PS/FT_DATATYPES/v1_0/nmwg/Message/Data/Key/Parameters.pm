package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters  -  this is data binding class for  'parameters'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'parameter' && $nsid eq 'nmwg' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::Key::Parameters::Parameter->new($childnode)
                };
