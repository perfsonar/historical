package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::CommonTime;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::CommonTime  -  this is data binding class for  'commonTime'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::CommonTime;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::CommonTime->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::CommonTime->new({xml => $xml_string});
...
use perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::Start;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::End;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwgr::Message::Data::CommonTime::Datum;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Data::CommonTime';
...
sub fromDOM {
	...
	my $element;
        ...
        if (!($self->get_value) && $tagname eq  'start' && $nsid eq 'nmtm' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::Start->new($childnode)
                };
              ...
              $self->set_start($element); ### add another start  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::End->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
              ...
              $self->set_end($element); ### add another end  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwgr::Message::Data::CommonTime::Datum->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
        ...
        elsif ($tagname eq  'datum' && $nsid eq 'filetransfer' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::CommonTime::Datum->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Datum : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
