package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata  -  this is data binding class for  'metadata'  element from the XML schema namespace nmwg
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata->new({xml => $xml_string});
...
use perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::min::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::median::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::mean::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::histogram::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::cdf::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Subject;
use perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::min::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::median::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::mean::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::histogram::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::cdf::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Parameters;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'subject' && $nsid eq 'nmwg' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Subject->new($childnode)
                };
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::mean::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::median::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::min::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::cdf::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::histogram::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
        ...
        elsif ($tagname eq  'subject' && $nsid eq 'filetransfer' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Subject->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Subject : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
              ...
              $self->set_subject($element); ### add another subject  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::average::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::mean::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::median::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::min::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::cdf::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::histogram::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
        ...
        elsif ($tagname eq  'parameters' && $nsid eq 'filetransfer' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Parameters->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  Parameters : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
               ...
               ($self->get_parameters && ref($self->get_parameters) eq 'ARRAY')?push @{$self->get_parameters}, $element:
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Key->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
