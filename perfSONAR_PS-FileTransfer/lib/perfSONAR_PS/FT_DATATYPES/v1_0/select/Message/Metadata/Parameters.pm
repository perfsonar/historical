package  perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Parameters;
...
perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Parameters  -  this is data binding class for  'parameters'  element from the XML schema namespace select
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Parameters->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Parameters->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::select::Message::Metadata::Parameters';
