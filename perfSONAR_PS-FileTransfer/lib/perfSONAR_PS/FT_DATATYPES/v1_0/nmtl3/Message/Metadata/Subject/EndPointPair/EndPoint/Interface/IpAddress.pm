package  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress  -  this is data binding class for  'ipAddress'  element from the XML schema namespace nmtl3
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{EndPoints}{DestIP}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress' ] if!(defined $query->{EndPoints}{DestIP}) || ref($query->{EndPoints}{DestIP});
     $query->{EndPoints}{SrcIP}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress' ] if!(defined $query->{EndPoints}{SrcIP}) || ref($query->{EndPoints}{SrcIP});
            ...
            foreach my $entry (@{$defined_table{$table}}) {
                if(ref($query->{$table}{$entry}) eq 'ARRAY') {
                    foreach my $classes (@{$query->{$table}{$entry}}) {
                         if($classes && $classes eq 'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress') {
        
                            if    ($self->get_type && ( (  ($entry eq 'DestIP') or  ($entry eq 'SrcIP')) )) {
