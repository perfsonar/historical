package  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IfAddress;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IfAddress  -  this is data binding class for  'ifAddress'  element from the XML schema namespace nmtl3
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IfAddress->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IfAddress->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IfAddress';
