package  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface  -  this is data binding class for  'interface'  element from the XML schema namespace nmtl3
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface->new({xml => $xml_string});
...
use perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IfAddress;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{EndPoints}{DestIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress',     ];
     $query->{EndPoints}{SrcIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress',     ];
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'ipAddress' && $nsid eq 'nmtl3' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IpAddress->new($childnode)
                };
              ...
              $self->set_ipAddress($element); ### add another ipAddress  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface::IfAddress->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
