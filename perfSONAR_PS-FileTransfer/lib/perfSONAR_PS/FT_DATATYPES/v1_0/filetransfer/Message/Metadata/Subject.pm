package  perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Subject;
...
perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Subject  -  this is data binding class for  'subject'  element from the XML schema namespace filetransfer

=head1 DESCRIPTION

Object representation of the subject element of the filetransfer XML namespace.
Object fields are:
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Subject->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Subject->new({xml => $xml_string});
...
use perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Subject';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'endPointPair' && $nsid eq 'nmwgt' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair->new($childnode)
                };
              ...
              $self->set_endPointPair($element); ### add another endPointPair  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
                    $self->get_LOGGER->logdie(" Failed to load and add  EndPointPair : " . $dom->toString . " error: " . $EVAL_ERROR);
                     return;
