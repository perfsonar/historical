package  perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Parameters;
...
perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Parameters  -  this is data binding class for  'parameters'  element from the XML schema namespace filetransfer

=head1 DESCRIPTION

Object representation of the parameters element of the filetransfer XML namespace.
Object fields are:
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Parameters->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Parameters->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Metadata::Parameters';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'parameter' && $nsid eq 'nmwg' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwg::Message::Metadata::Parameters::Parameter->new($childnode)
                };
