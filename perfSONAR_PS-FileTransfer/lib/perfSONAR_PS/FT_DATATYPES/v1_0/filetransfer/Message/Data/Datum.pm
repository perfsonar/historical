package  perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum;
...
perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum  -  this is data binding class for  'datum'  element from the XML schema namespace filetransfer
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{Data}{ID}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum' ] if!(defined $query->{Data}{ID}) || ref($query->{Data}{ID});
     $query->{Data}{NBytes}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum' ] if!(defined $query->{Data}{NBytes}) || ref($query->{Data}{NBytes});
     $query->{Data}{TransferTime}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum' ] if!(defined $query->{Data}{TransferTime}) || ref($query->{Data}{TransferTime});
     $query->{Data}{Duration}= [ 'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum' ] if!(defined $query->{Data}{Duration}) || ref($query->{Data}{Duration});
            ...
            foreach my $entry (@{$defined_table{$table}}) {
                if(ref($query->{$table}{$entry}) eq 'ARRAY') {
                    foreach my $classes (@{$query->{$table}{$entry}}) {
                         if($classes && $classes eq 'perfSONAR_PS::FT_DATATYPES::v1_0::filetransfer::Message::Data::Datum') {
