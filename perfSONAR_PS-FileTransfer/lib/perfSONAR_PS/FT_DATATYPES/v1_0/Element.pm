package perfSONAR_PS::FT_DATATYPES::v1_0::Element;
use strict;
use warnings;
...
perfSONAR_PS::FT_DATATYPES::v1_0::Element -  static class for basic element manipulations
...
use Data::Dumper;
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::Element';
Readonly::Hash   our %NSREGISTRY => ( 'topo' => 'http://ggf.org/ns/nmwg/topology/2.0/',
