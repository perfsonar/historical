package   perfSONAR_PS::FT_DATATYPES::v1_0::NSMap;
...
perfSONAR_PS::FT_DATATYPES::v1_0::NSMap - element names to namespace prefix mapper
...
=head1 SYNOPSIS
	...
	my $nsmap =  perfSONAR_PS::FT_DATATYPES::v1_0::NSMap->new();
...
Readonly::Scalar our $CLASSPATH => 'perfSONAR_PS::FT_DATATYPES::v1_0::NSMap';
