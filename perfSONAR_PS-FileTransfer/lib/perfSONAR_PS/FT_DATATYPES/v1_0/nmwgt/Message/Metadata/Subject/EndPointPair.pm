package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair  -  this is data binding class for  'endPointPair'  element from the XML schema namespace nmwgt
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair->new({xml => $xml_string});
...
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair::Src;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair::Dst;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     $query->{EndPoints}{SrcIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair::Src',     ];
     $query->{EndPoints}{DestIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair::Dst',     ];
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'src' && $nsid eq 'nmwgt' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair::Src->new($childnode)
                };
              ...
              $self->set_src($element); ### add another src  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmwgt::Message::Metadata::Subject::EndPointPair::Dst->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
