package  perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Parameters;
...
perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Parameters  -  this is data binding class for  'parameters'  element from the XML schema namespace max
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Parameters;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Parameters->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Parameters->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::max::Message::Parameters';
