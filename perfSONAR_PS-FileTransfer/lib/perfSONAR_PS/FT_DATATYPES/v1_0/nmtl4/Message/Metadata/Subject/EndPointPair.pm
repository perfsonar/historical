package  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair  -  this is data binding class for  'endPointPair'  element from the XML schema namespace nmtl4
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair';
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'endPoint' && $nsid eq 'nmtl4' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint->new($childnode)
                };
