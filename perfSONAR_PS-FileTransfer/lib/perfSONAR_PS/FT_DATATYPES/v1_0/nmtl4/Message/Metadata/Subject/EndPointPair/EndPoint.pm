package  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint  -  this is data binding class for  'endPoint'  element from the XML schema namespace nmtl4
...
=head1 SYNOPSIS
          ...
          use perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint;
          use Log::Log4perl qw(:easy);

          Log::Log4perl->easy_init();

          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint->new({xml => $xml_string});
...
use perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint::Address;
use perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface;
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint';
...
sub  querySQL {
    my ($self, $query) = @_;
     ...
     my %defined_table = ( 'EndPoints' => [   'DestIP',    'SrcIP',  ],  );
     $query->{EndPoints}{DestIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface',     ];
     $query->{EndPoints}{SrcIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface',     ];
     $query->{EndPoints}{DestIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint::Address',     ];
     $query->{EndPoints}{SrcIP}= [     'perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint::Address',     ];
...
sub fromDOM {
	...
	my $element;
        ...
        if ($tagname eq  'address' && $nsid eq 'nmtl4' && $self->can("get_$tagname")) {
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl4::Message::Metadata::Subject::EndPointPair::EndPoint::Address->new($childnode)
                };
              ...
              $self->set_address($element); ### add another address  
                ...
                eval {
                    $element = perfSONAR_PS::FT_DATATYPES::v1_0::nmtl3::Message::Metadata::Subject::EndPointPair::EndPoint::Interface->new($childnode)
                };
                if($EVAL_ERROR || !($element  && blessed $element)) {
