package  perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::End;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::End  -  this is data binding class for  'end'  element from the XML schema namespace nmtm
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::End->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::End->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::End';
