package  perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::Start;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::Start  -  this is data binding class for  'start'  element from the XML schema namespace nmtm
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::Start->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::Start->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmtm::Message::Data::CommonTime::Start';
