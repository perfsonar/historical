package  perfSONAR_PS::FT_DATATYPES::v1_0::nmwgr::Message::Data::Datum;
...
perfSONAR_PS::FT_DATATYPES::v1_0::nmwgr::Message::Data::Datum  -  this is data binding class for  'datum'  element from the XML schema namespace nmwgr
...
=head1 SYNOPSIS
          ...
          my $el =  perfSONAR_PS::FT_DATATYPES::v1_0::nmwgr::Message::Data::Datum->new($DOM_Obj);

          my $xml_string = $el->asString();

          my $el2 = perfSONAR_PS::FT_DATATYPES::v1_0::nmwgr::Message::Data::Datum->new({xml => $xml_string});
...
Readonly::Scalar our $CLASSPATH =>  'perfSONAR_PS::FT_DATATYPES::v1_0::nmwgr::Message::Data::Datum';
