package perfSONAR_PS::MP::Agent::Script;

=head1 NAME

perfSONAR_PS::MP::Agent::Script - A module that will run a given script and
return it's output.
...
=head1 SYNOPSIS
  ...
  my $agent = perfSONAR_PS::MP::Agent::Script( $command, $options );
  $agent->init();
...
our $logger = Log::Log4perl::get_logger( 'perfSONAR_PS::MP::Agent::Script' );
