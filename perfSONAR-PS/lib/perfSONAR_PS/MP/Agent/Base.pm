package perfSONAR_PS::MP::Agent::Base;

=head1 NAME

perfSONAR_PS::MP::Agent::Base - A module that contains the basic methods 
...
our $logger = Log::Log4perl::get_logger( 'perfSONAR_PS::MP::Agent::Base' );
