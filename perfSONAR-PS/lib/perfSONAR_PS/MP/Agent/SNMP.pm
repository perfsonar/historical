package perfSONAR_PS::MP::Agent::SNMP;


=head1 NAME

perfSONAR_PS::MP::Agent::SNMP - A module that will query a SNMP device and
return it's output.
...
our $logger = get_logger("perfSONAR_PS::MP::Agent::SNMP");
