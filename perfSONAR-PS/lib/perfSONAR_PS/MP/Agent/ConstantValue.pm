package perfSONAR_PS::MP::Agent::ConstantValue;

=head1 NAME

perfSONAR_PS::MP::Agent::ConstantValue - A perfsonar MP Agent class that returns
a constant value.
...
=head1 SYNOPSIS
  ...
  my $agent = perfSONAR_PS::MP::Agent::ConstantValue( 5 );
...
use perfSONAR_PS::MP::Agent::Base;
our @ISA = qw(perfSONAR_PS::MP::Agent::Base);

use Log::Log4perl qw(get_logger);
our $logger = Log::Log4perl::get_logger( 'perfSONAR_PS::MP::Agent::ConstantValue' );
