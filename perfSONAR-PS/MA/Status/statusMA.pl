...
statusMA.pl - An SNMP based MP (Measurement Point) and MA (MeasurementArchive).

=head1 DESCRIPTION

This script creates an MP/MA for an SNMP based collector.  The service is also capable
