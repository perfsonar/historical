...
create table link_nodes (link_id VARCHAR(255), node_id VARCHAR(255), interface VARCHAR(255), role VARCHAR(255), link_index INTEGER);
create table interfaces (node_id VARCHAR(255), name VARCHAR(255), type VARCHAR(255), capacity FLOAT);
