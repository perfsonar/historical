...
TODO:
{
	local $TODO = "Make count return -1 on error";

	#Note that fileXMLNoTag hasn't even been opened
	$cnt = $fileXMLNoTag->count("/alpha/beta");
	is($cnt, -1, "DB::File::count - XPath '/alpha/beta' unopened file");
}
...
TODO:
{
	local $TODO = "Make count return -1 on error";
	$cnt = $fileXML->count("/alpha/beta");
	is($cnt, -1, "DB::File::closeDB - XPath '/alpha/beta' unopened file");
}
